...
def main():
    ...
    if "voice_pipeline" not in st.session_state:
        try:
            ...
            st.sidebar.success("✅ Voice Pipeline Initialized")
            ...
            if start_session_button:
                ...
                if st.session_state.voice_pipeline:
                    try:
                        ...
                        st.sidebar.error(f"Voice Coach Error: {e}")
                        result = None

                    st.sidebar.write("Voice Result:", result)

                    if result:
                        st.session_state.audio_to_play, st.session_state.coach_feedback = result
                    else:
                        st.sidebar.error("Voice Pipeline is None")
